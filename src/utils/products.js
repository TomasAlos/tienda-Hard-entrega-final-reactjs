const productos = [
...

    {
        ...
        description: "La serie AMD Ryzen 7000 saca a relucir la velocidad descomunal de “Zen 4” y su potencia pura para que los jugadores y creadores puedan procesar cualquier juego o flujo de trabajo que se cruce en su camino.",
        stock: 6,
        type: "procesador",
        imageProduct: {
...

    {
        ...
        description: "Placa base AMD B550 AORUS con diseño digital de energía doble de 12 + 2 fases, disipadores de calor de superficie agrandados, PCIe dual 4.0 / 3.0 x4 M.2 con protectores térmicos duales, Intel® WiFi, LAN de 2.5GbE, USB frontal Type-C y RGB FUSION 2.0.",
        stock: 1,
        type: "placa madre",
        imageProduct: {
